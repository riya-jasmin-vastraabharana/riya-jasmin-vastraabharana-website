...
const PRODUCTS: ProductWithMedia[] = [
  ...
  { id: "s005", sku: "RJV-SAR-COT-001", name: "Abdul Sattar Billa", slug: "sage-green-chanderi", price: 2799, originalPrice: 4200, images: ["/Mission-Impossible.jpeg, /testing.jpeg"], video: "/testing.mp4", tag: "Sale", desc: "Lightweight Chanderi cotton, office and casual wear", stock: 30, material: "Chanderi Cotton", occasion: ["Daily","Office","Casual"], category: "sarees", subcategory: "cotton", whatsapp: "Hi! I want to order Sage Green Chanderi (RJV-SAR-COT-001) Rs 2899" },
...
const TICKER = ["Free Shipping above Rs. 1,999","New Festive Collection 2025 — Shop Now!","Authentic handwoven sarees from master weavers","WhatsApp: +91 93810 21541 for custom orders","Easy 7-day returns","Follow @rj_vastraabharana on Instagram","UPI: billa14673370@ybl | PhonePe: 9381021541"];
    ...
    <div style={{minHeight:"100vh",background:"#fdf6ef",fontFamily:"'EB Garamond',Georgia,serif",color:"#2c1810"}}>
      ...
      <div style={{background:"linear-gradient(135deg,#2c1810 0%,#5a2d0c 50%,#8B1A4A 100%)",padding:"64px 28px",textAlign:"center"}}>
        ...
        <div style={{display:"flex",justifyContent:"center",gap:36,marginTop:32,flexWrap:"wrap"}}>
          <a href={SITE_CONFIG.social.instagram.url} target="_blank" rel="noreferrer" style={{textAlign:"center",textDecoration:"none"}}><div style={{display:"flex",justifyContent:"center",marginBottom:4}}><IcoIG s={22}/></div><div style={{fontSize:12,color:"#B8860B"}}>@rj_vastraabharana</div><div style={{fontSize:11,color:"#8B6040"}}>Instagram</div></a>
          <a href={SITE_CONFIG.social.facebook.url} target="_blank" rel="noreferrer" style={{textAlign:"center",textDecoration:"none"}}><div style={{display:"flex",justifyContent:"center",marginBottom:4}}><IcoFB s={22}/></div><div style={{fontSize:12,color:"#B8860B"}}>rj_vastraabharana</div><div style={{fontSize:11,color:"#8B6040"}}>Facebook</div></a>
